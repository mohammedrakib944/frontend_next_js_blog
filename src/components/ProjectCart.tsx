      ...
      <div className={data.reverse ? "order-1 text-center" : "text-center"}>
        ...
        <div className="flex items-center justify-center gap-6">
          <Link
            href={data.github}
            target="_blank"
            className="flex items-center gap-2 hover:underline text-sm font-semibold"
          >
            <Image className="w-5" src={Icons.github} alt="Git Hub" /> GitHub
          </Link>
          <Link
            href={data.live}
            target="_blank"
            className="flex items-center gap-2 hover:underline text-sm font-semibold"
          >
            <Image className="w-4" src={Icons.rightArrow} alt="Out link" /> Live
            Demo
          </Link>
        </div>
      </div>
